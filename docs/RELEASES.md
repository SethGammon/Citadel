...
node scripts/release-verify.js "dist/release/citadel-$TAG.tar.gz" --ref "$TAG" --version 1.4.0
```
...
```sh
node scripts/release-verify.js /path/to/citadel-v1.4.0.tar.gz \
  --ref v1.4.0 --version 1.4.0
```
...
```sh
gh attestation verify /path/to/citadel-v1.4.0.tar.gz -R SethGammon/Citadel
gh attestation verify /path/to/citadel-v1.4.0.tar.gz.manifest.json -R SethGammon/Citadel
gh attestation verify /path/to/citadel-v1.4.0.tar.gz.sha256 -R SethGammon/Citadel
```
...
```sh
node scripts/update.js --archive /path/to/citadel-v1.4.0.tar.gz --target /path/to/Citadel
```
...
```sh
node scripts/update.js --archive /path/to/citadel-v1.4.0.tar.gz --target /path/to/Citadel --apply
```
