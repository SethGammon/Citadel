...
module.exports = Object.freeze({
  ...
  capabilities: {
    ...
    skills: { support: 'full', notes: 'Discovers .claude/skills, .agents/skills and .opencode/{skill,skills} trees, plus every path in opencode.json skills.paths. Citadel installs a project-local skill projection and delegates utility commands back to the checkout; each skill also becomes a slash command.' },
